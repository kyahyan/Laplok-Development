<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="terms-services.aspx.cs" Inherits="Laplok_Developed.terms_services" %>
            ...
            <div class="pe-lg-4 me-lg-3 pe-xl-0 me-xl-0">
              <ol>
                ...
                <li>
                  ...
                  <p class="fs-5 mb-3">Except for any products designated on the Site as non-returnable, we will accept a return of the products for a refund of your purchase price, less the original shipping and handling costs, provided such return is made within 30 days of shipment and provided such products are returned in their original condition. To return products, you must call  <a href="tel:4065550120" class="text-primary">1-800-TechLok</a> or email our Returns Department at <a class="text-primary" href="mailto:Return@LapLok.com">Return@LapLok.com</a>  to obtain a Return Merchandise Authorization (<span class="fw-bolder">RMA</span>) number before shipping your product. No returns of any type will be accepted without an RMA number. You are responsible for all shipping and handling charges on returned items. You bear the risk of loss during shipment. Your refund will be credited back to the same payment method used to make the original purchase on the Site. WE OFFER NO REFUNDS ON ANY PRODUCTS DESIGNATED ON THIS SITE AS NON-RETURNABLE.</p>
                </li>
                <li>
                  ...
                  <p class="fs-5 fw-bolder mb-3">OUR RESPONSIBILITY FOR DEFECTIVE PRODUCTS IS LIMITED TO REPAIR, REPLACEMENT OR REFUND AS SET FORTH IN THIS WARRANTY STATEMENT. NEITHER ANY PERFORMANCE OR OTHER CONDUCT, NOR ANY ORAL OR WRITTEN INFORMATION, STATEMENT OR ADVICE PROVIDED BY US OR ANY OF OUR SUPPLIERS, AGENTS OR EMPLOYEES WILL CREATE A WARRANTY, OR IN ANY WAY INCREASE THE SCOPE OR DURATION OF THIS LIMITED WARRANTY.</p>
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        <p class="fs-5 mb-3"> To obtain warranty service, you must call <a href="tel:4065550120" class="text-primary">1-800-TechLok</a> or email our Customer Service Department at <a class="text-primary" href="mailto:Return@LapLok.com">Return@LapLok.com</a>  during the Warranty Period to obtain an RMA number. No warranty service will be provided without an RMA number.</p>
