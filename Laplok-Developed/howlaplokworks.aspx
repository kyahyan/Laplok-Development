<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="howlaplokworks.aspx.cs" Inherits="Laplok_Developed.howlaplokworks" %>
    ...
    <div class="row g-0">
      ...
      <div class="col-xl-5 col-lg-6 position-relative py-5">
        ...
        <div class="position-relative zindex-5 text-center text-lg-start px-3 px-lg-0 py-xl-4 py-xxl-5 mt-lg-3 mx-auto mx-lg-0" style="max-width: 530px;">
          ...
          <div class="justify-content-center justify-content-lg-start text-start mb-2">
            <div class="fs-xl">LapLok is the ultimate way to lock down, secure, and protect your laptop wherever you&#39;re working. Who
             ...
             <div class="fs-xl mt-2 mt-lg-1">Watch this quick video for clear instructions on how to use this powerful and dynamic device protection device, 
              or simply scroll down for step-by-step instructions.</div>
          </div>
